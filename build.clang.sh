...
PATH=:"${KERNEL_DIR}/clang-gengkapak/bin:${PATH}:${KERNEL_DIR}/stock/bin:${PATH}:${KERNEL_DIR}/stock_32/bin:${PATH}"
...
GITHUB_URL="https://github.com/Risti699/Karamel/tree/JFla-Karamel/commits/"
